...
public class ExampleFlowWithEvolvableToken {
    ...
    public static class IssueEvolvableTokenFlow extends FlowLogic<SignedTransaction>{
        ...
        public SignedTransaction call() throws FlowException {
            ...
            StateAndRef<MyTokenType> stateAndRef = getServiceHub().getVaultService().
                    queryBy(MyTokenType.class, queryCriteria).getStates().get(0);
            MyTokenType evolvableTokenType = stateAndRef.getState().getData();
    ...
    public static class CreateEvolvableTokenFlow extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            //create token type
            MyTokenType evolvableTokenType = new MyTokenType(importantInformationThatMayChange, getOurIdentity(),
